                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {teamMembers.map((member, idx) => (
                        <motion.div
                            ...
                            className={`relative overflow-hidden border ${member.isLeader ? 'border-primary/20 bg-foreground/[0.03]' : 'border-border-brand bg-surface'} group`}
                        >
                            {/* Leader Badge */}
                            {member.isLeader && (
                            ...
                            <div className="p-8 border-t border-border-brand bg-surface/40 backdrop-blur-sm flex flex-col gap-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex gap-2">
                                        <button title="Düzenle" className="size-10 flex items-center justify-center border border-border-brand text-text-secondary hover:text-foreground hover:border-foreground/20 transition-all bg-foreground/5">
                                            <Edit2 size={12} />
                                        </button>
                                        <button title="Sil" className="size-10 flex items-center justify-center border border-border-brand text-text-secondary/30 hover:text-red-500 hover:border-red-500/20 transition-all bg-foreground/5">
                                            <Trash2 size={12} />
                                        </button>
                                    </div>
                                </div>
