...
const categories = ["Proje", "Kurumsal", "Sosyal Sorumluluk", "İnsan Kaynakları", "Duyuru"];
...
export default function NewsAdminPage() {
    ...
    const openModal = (item?: NewsItem) => {
        if (item) {
            ...
            setEditingItem(null);
            setFormData({ title: "", summary: "", content: "", category: "Duyuru", image_url: "" });
        }
        setIsModalOpen(true);
    };
    ...
    return (
        <DashboardLayout title="Haberler Yönetimi">
